      ...
      <div className="flex flex-col items-center">
        ...
        >
          ...
          <ImageWithText
            ...
            textTop={t("contentPageEducation.universityName")}
            textBottom={t("contentPageEducation.universitySpecialty")}
          />
          <ImageWithText
            logo={
              "M496 128v16a8 8 0 0 1-8 8h-24v12c0 6.627-5.373 12-12 12H60c-6.627 0-12-5.373-12-12v-12H24a8 8 0 0 1-8-8v-16a8 8 0 0 1 4.941-7.392l232-88a7.996 7.996 0 0 1 6.118 0l232 88A8 8 0 0 1 496 128zm-24 304H40c-13.255 0-24 10.745-24 24v16a8 8 0 0 0 8 8h464a8 8 0 0 0 8-8v-16c0-13.255-10.745-24-24-24zM96 192v192H60c-6.627 0-12 5.373-12 12v20h416v-20c0-6.627-5.373-12-12-12h-36V192h-64v192h-64V192h-64v192h-64V192H96z"
            }
            textTop={t("contentPageEducation.collegeName")}
            textBottom={t("contentPageEducation.collegeSpecialty")}
          />
        </motion.div>
        <h1 className="w-full max-w-3xl text-left text-2xl font-semibold mb-4 text-left text-3xl mb-8">
          {t("contentPageEducation.certifications")}
        </h1>
        ...
        <div className="w-full max-w-3xl text-left flex flex-col gap-5">
          ...
          >
            <ImageWithText
              ...
              textTop={t("contentPageEducation.certPythonTop")}
              textBottom={t("contentPageEducation.certPythonBottom")}
            />
          </motion.div>
          ...
          >
            <ImageWithText
              ...
              viewBox="0 0 24 24"
              textTop={t("contentPageEducation.certRedHatTop")}
              textBottom={t("contentPageEducation.certRedHatBottom")}
            />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <ImageWithText
              ...
              viewBox="0 0 24 24"
              textTop={t("contentPageEducation.certCiscoTop")}
              textBottom={t("contentPageEducation.certCiscoBottom")}
            />
          </motion.div>
          <motion.div
            ref={textRef}
          ...
          >
            <p>{t("contentPageEducation.text")}</p>
          </motion.div>
        </div>
      </div>
    </div>
